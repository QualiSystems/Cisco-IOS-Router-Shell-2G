...
class TestCiscoIOSShellDriver(unittest.TestCase):
    ...
    def test_get_inventory(self, mocked_resource_model, mocked_class, mocked_cli, mocked_context,
                           mocked_resource_details, mocked_logger, mocked_api):
        # Arrange
    ...
    def test_run_custom_command(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                                mocked_api):
        # Arrange
    ...
    def test_health_check(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                          mocked_api):
        # Arrange
        response = 'response'
    ...
    @patch('driver.CommandFlow')
    def test_run_custom_config_command(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                       mocked_logger,
                                       mocked_api):
        # Arrange
        command = 'test command'
    ...
    def test_load_firmware(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                           mocked_api):
        # Arrange
        path = 'test'
    ...
    @patch('driver.FirmwareFlow')
    def test_load_firmware_no_vrf(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                  mocked_logger,
                                  mocked_api):
        # Arrange
        path = 'test'
        ...
        # Act
        self.driver.initialize(mocked_context)
        self.driver.load_firmware(context=mocked_context, path=path, vrf_management_name=vrf_management_name)

        # Assert
        mocked_class.return_value.load_firmware.assert_called_with(path=path, vrf_management_name=vrf_management_name)

    @patch('driver.ConfigurationFlow')
    def test_save_no_params(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                            mocked_api):
        # Arrange
        mocked_class.return_value.save.return_value = ''
        vrf_management_name = 'default'
        mocked_resource_details.from_context.return_value.vrf_management_name = vrf_management_name
    ...
    @patch('driver.ConfigurationFlow')
    def test_save_all_params(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                             mocked_api):
        # Arrange
    ...
    @patch('driver.ConfigurationFlow')
    def test_save_no_vrf(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                         mocked_api):
        # Arrange
        folder_path = 'ftp://ftpuser:ftppass@server/folder'
        configuration_type = 'running'
    ...
    @patch('driver.ConfigurationFlow')
    def test_save_no_vrf_no_folder_path(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                        mocked_logger,
                                        mocked_api):
        # Arrange
        configuration_type = 'running'
    ...
    @patch('driver.ConfigurationFlow')
    def test_save_no_vrf_no_config_file(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                        mocked_logger,
                                        mocked_api):
        # Arrange
        folder_path = 'ftp://ftpuser:ftppass@server/folder'
    ...
    @patch('driver.ConfigurationFlow')
    def test_restore_all_params(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                                mocked_api):
        # Arrange
    ...
    @patch('driver.ConfigurationFlow')
    def test_restore_no_vrf(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details, mocked_logger,
                            mocked_api):
        # Arrange
        path = 'ftp://ftpuser:ftppass@server/folder'
        configuration_type = 'startup'
    ...
    @patch('driver.ConfigurationFlow')
    def test_restore_no_vrf_no_restore_method(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                              mocked_logger, mocked_api):
        # Arrange
        path = 'ftp://ftpuser:ftppass@server/folder'
        configuration_type = 'startup'
        vrf = 'management'
    ...
    @patch('driver.ConfigurationFlow')
    def test_restore_no_optional_params(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                        mocked_logger,
                                        mocked_api):
        # Arrange
        path = 'ftp://ftpuser:ftppass@server/folder'
    ...
    def test_orchestration_save_no_optional_params(self, mocked_orch_service, mocked_class, mocked_cli, mocked_context,
                                                   mocked_resource_details,
                                                   mocked_logger, mocked_api):
        # Arrange
        save_response = "success"
        mocked_class.return_value.orchestration_save.return_value = save_response
        mocked_orch_service.return_value.prepare_orchestration_save_result.return_value = ""
        ...
        # Assert
        mocked_orch_service.return_value.prepare_orchestration_save_result.assert_called_once_with(save_response)
        mocked_class.return_value.orchestration_save.assert_called_with(mode='shallow', custom_params=None)

    @patch('driver.ConfigurationFlow')
    @patch('driver.OrchestrationSaveRestore')
    def test_orchestration_save(self, mocked_orch_service, mocked_class, mocked_cli, mocked_context,
                                mocked_resource_details, mocked_logger,
                                mocked_api):
        # Arrange
        mode = 'shallow'
        ...
        # Act
        self.driver.initialize(mocked_context)
        self.driver.orchestration_save(mocked_context, mode='shallow', custom_params=custom_params)
    ...
    @patch('driver.ConfigurationFlow')
    @patch('driver.OrchestrationSaveRestore')
    def test_orchestration_save_no_custom_params(self, mocked_orch_service, mocked_class, mocked_cli, mocked_context,
                                                 mocked_resource_details,
                                                 mocked_logger, mocked_api):
        # Arrange
        save_response = "success"
    ...
    @patch('driver.ConfigurationFlow')
    @patch('driver.OrchestrationSaveRestore')
    def test_orchestration_restore_no_custom_params(self, mocked_orch_service, mocked_class, mocked_cli, mocked_context,
                                                    mocked_resource_details,
                                                    mocked_logger, mocked_api):
        # Arrange
        ...
        mocked_class.return_value.restore.return_value = ''
        parse_result = {}
        mocked_orch_service.return_value.parse_orchestration_save_result.return_value = parse_result
        ...
        # Assert
        mocked_orch_service.return_value.parse_orchestration_save_result.assert_called_once_with(saved_artifact_info)
        mocked_class.return_value.restore.assert_called_with(**parse_result)

    @patch('driver.ConfigurationFlow')
    @patch('driver.OrchestrationSaveRestore')
    def test_orchestration_restore_all_params(self, mocked_orch_service, mocked_class, mocked_cli, mocked_context,
                                              mocked_resource_details,
                                              mocked_logger, mocked_api):
        # Arrange
        saved_artifact_info = 'test json'
    ...
    def test_apply_connectivity_changes(self, mocked_class, mocked_cli, mocked_context, mocked_resource_details,
                                        mocked_logger,
                                        mocked_api):
        # Arrange
        request = 'test json'
